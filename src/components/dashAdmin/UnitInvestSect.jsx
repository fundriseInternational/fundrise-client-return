      ...
      <div className="profileEditableDisplay">
        ...
        <div className="theFormField">
          <div className="unitInputField">
            ...
            <input
              type="text"
              value={investData?.roi}
              onChange={(e) => {
                setInvestData({
                  ...investData,
                  roi: parseInt(e.target.value !== "" ? e.target.value : "0"),
                });
              }}
            />
          </div>
          ...
          <div className="unitInputField">
            ...
            <input
              type="text"
              disabled
              value={`${investData?.duration} days`}
            />
          </div>
          <div className="unitInputField">
          ...
          <div className="unitInputField">
            ...
            <input
              type="text"
              disabled
              value={new Date(investData?.date).toLocaleDateString("en-US", {
                day: "numeric",
                month: "short",
                year: "numeric",
              })}
          ...
          <div className="unitInputField">
            ...
            <input
              ...
              value={new Intl.DateTimeFormat("en-US", {
                ...
                minute: "2-digit",
                hour12: true,
              }).format(new Date(investData?.date))}
            />
          </div>
        </div>
